<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li><a href="<?php echo site_url('dea/backend/team/view');?>">Đội ngũ</a></li>
		<li class="active"><a href="<?php echo site_url('dea/backend/team/update/'.$Detailaddress['id']);?>">Cập nhật bản ghi</a></li>
	</ol>
</section>
						...
						<div class="tab-pane active" id="tab-info">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<?php echo form_input('address', set_value('address', $Detailaddress['address']), 'class="form-control" placeholder="Chức vụ"');?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label">Links Facebook</label>
									<div class="col-sm-9">
										<?php echo form_input('content', set_value('content', $Detailaddress['content']), 'class="form-control" placeholder="Links Facebook"');?>
									</div>
								</div>
							</div><!-- /.box-body -->
						</div><!-- /.tab-pane -->
