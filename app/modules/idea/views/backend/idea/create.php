<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active"><a href="<?php echo site_url('idea/backend/idea/create');?>">Thêm mới</a></li>
	</ol>
</section>
			...
			<div class="col-md-9">
				<div class="nav-tabs-custom">
						...
						<div class="tab-pane active" id="tab-info">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<?php echo form_textarea('content', set_value('content'), 'class="form-control" placeholder="Nội dung" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"');?>
									</div>
								</div>
							</div><!-- /.box-body -->
						</div><!-- /.tab-pane -->
					...
					<div class="box-footer">
						<button type="reset" class="btn btn-default">Làm lại</button><input type="hidden" name="type" value="0">
