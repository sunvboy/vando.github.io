<section class="content-header">
	<h1>Thêm nhóm thành viên mới</h1>
	<ol class="breadcrumb">
		<li><a href="<?php echo site_url('admin');?>"><i class="fa fa-dashboard"></i> Bảng điều khiển</a></li>
		<li><a href="<?php echo site_url('users/backend/groups/view');?>">Nhóm thành viên</a></li>
		<li class="active"><a href="<?php echo site_url('users/backend/groups/create');?>">Thêm nhóm thành viên mới</a></li>
	</ol>
</section>
						...
						<div class="tab-pane active" id="tab-info">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<?php echo form_input('title', set_value('title'), 'class="form-control" placeholder="Nhóm thành viên"');?>
									</div>
								</div>
								<?php
