...
class FrontendTeachers_Model extends FC_Model{
	...
	// Count All
	//-----------------------------------------------------
	public function Count($lang = 'vietnamese', $teachersid = 0){
		$this->db->where(array('trash' => 0, 'publish' => 1, 'alanguage' => $lang, 'teachersid' => $teachersid));
	...
	// All
	//-----------------------------------------------------
	public function All( $start = 0, $limit = 0, $lang = 'vietnamese', $teachersid = 0){
