						...
						<div class="tab-pane active" id="tab-info">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<?php echo form_input('title', set_value('title'), 'class="form-control form-static-link" placeholder="Tên giảng viên"');?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label tp-text-left">Chức vụ</label>
									<div class="col-sm-8">
										<?php echo form_input('chucvu', set_value('chucvu'), 'class="form-control form-static-link" placeholder="Tên chức vụ, chuyên ngành"');?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label tp-text-left">Facebook</label>
									<div class="col-sm-8">
										<?php echo form_input('facebook', set_value('facebook'), 'class="form-control form-static-link" placeholder="Links Facebook"');?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label tp-text-left">Messenger</label>
									<div class="col-sm-8">
										<?php echo form_input('messenger', set_value('messenger'), 'class="form-control form-static-link" placeholder="Links messenger"');?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label tp-text-left">Videos giới thiệu</label>
									<div class="col-sm-10">
										<?php echo form_textarea('video', htmlspecialchars_decode(set_value('video')), 'placeholder="Videos giới thiệu" style="width: 100%; height: 150px;"');?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label tp-text-left">Mô tả</label>
									<div class="col-sm-10">
										<?php echo form_textarea('description', htmlspecialchars_decode(set_value('description')), 'id="txtDescription" class="ckeditor-description" placeholder="Mô tả ngắn"');?>
									</div>
								</div>
							</div><!-- /.box-body -->
						</div><!-- /.tab-pane -->
