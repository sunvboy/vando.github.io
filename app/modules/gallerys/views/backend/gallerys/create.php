<section class="content-header">
	<h1>Thêm album ảnh mới</h1>
	<ol class="breadcrumb">
		<li><a href="<?php echo site_url('admin');?>"><i class="fa fa-dashboard"></i> Bảng điều khiển</a></li>
		<li><a href="<?php echo site_url('gallerys/backend/gallerys/view');?>">Album ảnh</a></li>
		<li class="active"><a href="<?php echo site_url('gallerys/backend/gallerys/create');?>">Thêm album ảnh mới</a></li>
	</ol>
</section>
							...
							<div class="tab-pane active" id="tab-info">
								<div class="box-body">
									<div class="form-group">
										<label class="col-sm-2 control-label tp-text-left">Album ảnh</label>
										<div class="col-sm-8">
											<?php echo form_input('title', set_value('title'), 'class="form-control form-static-link" placeholder="Album ảnh"');?>
										</div>
