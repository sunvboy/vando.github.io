<section class="content-header">
	<h1>Cập nhật Danh mục thuộc tính</h1>
	<ol class="breadcrumb">
		<li><a href="<?php echo site_url('admin');?>"><i class="fa fa-dashboard"></i> Bảng điều khiển</a></li>
		<li><a href="<?php echo site_url('attributes/backend/catalogues/view');?>">Danh mục thuộc tính</a></li>
		<li class="active"><a href="<?php echo site_url('attributes/backend/catalogues/update/'.$DetailAttributesCatalogues['id']);?>">Cập nhật Danh mục thuộc tính</a></li>
	</ol>
</section>
						...
						<div class="tab-pane active" id="tab-info">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-sm-6">
										<?php echo form_input('title', set_value('title', $DetailAttributesCatalogues['title']), 'class="form-control" placeholder="Danh mục thuộc tính"');?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label">Từ khóa</label>
									<div class="col-sm-6">
										<?php echo form_input('keyword', set_value('keyword', $DetailAttributesCatalogues['keyword']), 'class="form-control" placeholder="Danh mục thuộc tính"');?>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<?php echo form_textarea('description', htmlspecialchars_decode(set_value('description', $DetailAttributesCatalogues['description'])), 'id="txtDescription" class="ckeditor-description" placeholder="Mô tả" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"');?>
									</div>
								</div>
							</div><!-- /.box-body -->
						</div><!-- /.tab-pane -->
						...
						<div class="tab-pane" id="tab-advanced">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-sm-2">
										<?php echo form_dropdown('publish', $this->configbie->data('publish'), set_value('publish', $DetailAttributesCatalogues['publish']), 'class="form-control" style="width: 100%;"');?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label">Vị trí</label>
									<div class="col-sm-2">
										<?php echo form_input('order', set_value('order', $DetailAttributesCatalogues['order']), 'class="form-control" placeholder="Vị trí"');?>
									</div>
								</div>
							</div><!-- /.box-body -->
						</div><!-- /.tab-pane -->
