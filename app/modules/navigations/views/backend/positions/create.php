<section class="content-header">
	<h1>Thêm danh mục Menu mới</h1>
	<ol class="breadcrumb">
		<li><a href="<?php echo site_url('admin');?>"><i class="fa fa-dashboard"></i> Bảng điều khiển</a></li>
		<li><a href="<?php echo site_url('navigations/backend/positions/view');?>">Danh mục Menu</a></li>
		<li class="active"><a href="<?php echo site_url('navigations/backend/positions/create');?>">Thêm danh mục Menu mới</a></li>
	</ol>
</section>
						...
						<div class="tab-pane active" id="tab-info">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-sm-5">
										<?php echo form_input('title', set_value('title'), 'class="form-control" placeholder="Danh mục Menu"');?>
									</div>
								</div>
								<div class="form-group">
