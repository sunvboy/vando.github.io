...
class Address extends FC_Controller{
	...
	public function view($page = 1){
		$page = (int)$page;
		$config['total_rows'] = $this->Backendaddress_Model->countall($this->fclang, 0);
		if($config['total_rows'] > 0){
			...
			$page = $page - 1;
			$data['listSupport'] = $this->Backendaddress_Model->view(($page * $config['per_page']), $config['per_page'], $this->fclang, 0);	
		}
