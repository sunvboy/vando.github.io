						...
						<div class="tab-pane active" id="tab-info">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-sm-4">
										<?php echo form_input('title', set_value('title', $Detailaddress['title']), 'class="form-control" placeholder="Tên quốc gia"');?>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<?php echo form_input('type', set_value('type', $Detailaddress['type']), 'class="form-control" placeholder="Links liên kết"');?>
									</div>
									<label class="col-sm-1 control-label">Hình ảnh</label>
									<div class="col-sm-4">
										<?php echo form_input('attachs', set_value('attachs', $Detailaddress['attachs']), 'class="form-control" placeholder="Hình ảnh" onclick="openKCFinder(this)"'); ?>
									</div>
								</div>
							</div><!-- /.box-body -->
						</div><!-- /.tab-pane -->
