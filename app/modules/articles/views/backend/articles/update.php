						...
						<div class="tab-content">
							...
							<div class="tab-pane active" id="tab-info">
								<div class="box-body">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label tp-text-left">Phong cách</label>
										<div class="col-sm-10">
											<?php echo form_input('content2', set_value('content2', $DetailArticles['content2']), 'class="form-control" placeholder="Phong cách"'); ?>
										</div>
									</div>
									<div class="form-group">
