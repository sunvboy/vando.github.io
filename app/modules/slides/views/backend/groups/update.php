...
<section class="content-header">
	<h1>Cập nhật nhóm slide</h1>
	<ol class="breadcrumb">
		<li><a href="<?php echo site_url('admin');?>"><i class="fa fa-dashboard"></i> Bảng điều khiển</a></li>
		<li><a href="<?php echo site_url('slides/backend/groups/view');?>">Nhóm slide</a></li>
		<li class="active"><a href="<?php echo site_url('slides/backend/groups/update/'.$detailSlidesGroups['id']);?>">Cập nhật nhóm slide</a></li>
	</ol>
</section>
						...
						<div class="tab-pane active" id="tab-info">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<?php echo form_input('title', set_value('title', $detailSlidesGroups['title']), 'class="form-control" placeholder="Nhóm slide"');?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label">Liên kết danh mục</label>
									<div class="col-sm-8">
										<?php echo form_input('href', set_value('href', $detailSlidesGroups['href']), 'class="form-control" placeholder="Liên kết danh mục"');?>
									</div>
								</div>
								<div class="form-group hide">
									<label class="col-sm-2 control-label">Từ khóa</label>
									<div class="col-sm-8">
										<?php echo form_input('keyword', set_value('keyword', $detailSlidesGroups['keyword']), 'class="form-control" placeholder="Keyword"');?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label">Mô tả</label>
									<div class="col-sm-10">
										<?php echo form_textarea('description', htmlspecialchars_decode(set_value('description', $detailSlidesGroups['description'])), 'class="textarea" placeholder="Mô tả" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"');?>
									</div>
								</div>
							</div><!-- /.box-body -->
						</div><!-- /.tab-pane -->
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<?php echo form_dropdown('publish'.$x, $this->configbie->data('publish'), set_value('publish'.$x, $value['publish']), 'class="form-control" style="width: 100%;"');?>
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-3 control-label">Tiêu đề ảnh</label>
														<div class="col-sm-9"><?php echo form_textarea('title'.$x, $value['title'], 'placeholder="title"');?></div>
													</div>
													<div class="form-group">
										...
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<div class="modal-body">
													...
													<div class="form-group">
														<label class="col-sm-3 control-label">Tiêu đề ảnh</label>
														<div class="col-sm-9"><?php echo form_textarea('title'.$x, '', 'placeholder="title"');?></div>
													</div>
													<div class="form-group">
														<label class="col-sm-3 control-label">Mô tả ảnh</label>
						...
						<div class="tab-pane" id="tab-advanced">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-sm-2">
										<?php echo form_dropdown('publish', $this->configbie->data('publish'), set_value('publish', $detailSlidesGroups['publish']), 'class="form-control" style="width: 100%;"');?>
									</div>
									<label class="col-sm-2 control-label">Vị trí</label>
									<div class="col-sm-2">
										<?php echo form_input('order', set_value('order', $detailSlidesGroups['order']), 'class="form-control" placeholder="Vị trí"');?>
									</div>
								</div>
							</div><!-- /.box-body -->
						</div><!-- /.tab-pane -->
							...
							'<div class="modal fade" id="modal'+x+'">' +
								'<div class="modal-dialog">' +
									'<div class="modal-content">' +
										...
										'<div class="modal-body">' +
											'<div class="fc-upload-thumb fc-crop-center-img-h"><img src="templates/backend/dist/img/default.png" alt="" id=""></div>' +
											'<div class="form-group">' +
												'<label class="col-sm-3 control-label">Đường dẫn ảnh</label>' +
											...
											'<div class="form-group">' +
												'<label class="col-sm-3 control-label">Xuất bản</label>' +
												'<div class="col-sm-9">'+
												'<select name="publish'+x+'" class="form-control" style="width: 100%;">' +
