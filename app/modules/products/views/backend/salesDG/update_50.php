<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active"><a href="<?php echo site_url('products/backend/SalesDG/create');?>">Thêm sản phẩm mới</a></li>
	</ol>
</section>
				...
				<div class="nav-tabs-custom">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab-seo">
							...
							<div class="form-group">
								<label class="col-sm-12 control-label tp-text-left">Phần trăm giảm giá(Đơn vị: %)</label>
								<div class="col-sm-12">
									<?php echo form_input('saleoff', set_value('saleoff', $DetailProducts['phantram']), 'class="form-control " placeholder="Phần trăm giảm giá(Đơn vị: %)"');?>
								</div>
							</div>
							<div class="form-group">
