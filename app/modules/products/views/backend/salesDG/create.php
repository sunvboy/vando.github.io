										...
										<div class="row">
											<div class="col-sm-6">
												...
												<div class="input-group">
													...
													<input type="text" name="time_start" class="form-control datetimemonthsale change_time" value="<?php echo date('d/m/Y', time() + 7*3600) ?>">
												</div>
											</div>
											<div class="col-sm-6 mb15">
												...
												<div class="input-group">
													...
													<input type="text" name="time_end" class="form-control datetimemonthsale change_time" value="<?php echo date('d/m/Y',strtotime($time . "+1 days")); ?>">
												</div>
											</div>
										</div>
									</div>
							...
							<div class="box-body">
								...
								<div id="list-combo-product">
									<table class="table" id="diagnosis-list">
										...
										<tbody>
											<?php  	$id_combo = $this->input->post('id_combo');
												if (!empty($id_combo)) {
					...
					<ul class="nav nav-tabs">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab-seo">
								...
								<div class="form-group">
									<label class="col-sm-12 control-label tp-text-left">Giá</label>
									<div class="col-sm-12">
										<?php echo form_input('saleoff', set_value('saleoff'), 'class="form-control price" placeholder="Giá tiền"');?>
									</div>
								</div>
