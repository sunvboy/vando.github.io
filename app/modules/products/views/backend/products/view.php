...
<!--					<th>Nổi bật</th>-->
				...
				<tr>
					...
					<td><?php echo str_replace(',', ',', number_format(count_phien_ban($item['id']))); ?></td>
					<td><?php echo str_replace(',', ',', number_format($item['quantity'])); ?></td>
<!--					<td>--><?php //echo $this->configbie->data('status', ((!empty($item['quantity'])) ? 0 : 1 )); ?><!--</td>-->
					<td>
						<a href="<?php echo site_url('products/backend/products/set/status/'.$item['id'].'?redirect='.urlencode(current_url())); ?>" title="" class="status-publish">
