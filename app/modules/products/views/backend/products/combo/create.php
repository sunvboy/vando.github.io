<div class="tab-pane" id="tab-combo">
    <div class="box-body">
        <div class="callout callout-danger">Thêm sản phẩm khuyến mại</div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <input type="hidden" name="id_sanphamtangkem" id="id_arr" value="">
        ...
        <div id="list-combo-product">
            <table class="table" id="diagnosis-list">
                ...
                <tbody>
                <?php
                $id_combo = $this->input->post('id_sanphamtangkem');
                if (!empty($id_combo)) {
