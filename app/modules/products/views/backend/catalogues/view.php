		...
		<div class="box-body table-responsive no-padding">
			...
			<table class="table table-hover" id="diagnosis-list">
				<tr>
					...
					<th>Thời gian</th>
					<th>Xuất bản</th>
					<th>Sản phẩm áo trang chủ</th>
					<th>Sản phẩm quần trang chủ</th>
					<th>Nổi bật 1</th>
					<th>Nổi bật 2</th>
				...
				<tr>
					...
					<td>
						<a href="<?php echo site_url('products/backend/catalogues/set/isaside/'.$item['id'].'?redirect='.urlencode(current_url())); ?>" title="" class="status-publish">
