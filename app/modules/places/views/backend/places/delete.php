<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li><a href="<?php echo site_url('places/backend/places/view');?>">địa điểm</a></li>
		<li class="active"><a href="<?php echo site_url('places/backend/places/delete/'.$DetailPlaces['id']);?>">Xóa địa điểm</a></li>
	</ol>
</section>
