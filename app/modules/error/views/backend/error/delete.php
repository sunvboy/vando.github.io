<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li><a href="<?php echo site_url('comments/backend/comments/view');?>">hỗ trợ trực tuyến</a></li>
		<li class="active"><a href="<?php echo site_url('comments/backend/comments/delete/'.$Detailcomments['id']);?>">Xóa hỗ trợ trực tuyến</a></li>
	</ol>
</section>
