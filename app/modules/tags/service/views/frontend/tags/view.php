	...
	<div class="banner-page  uk-text-center" >
        <div class="absulute-page " >
			<header class="panelhead" style="background: url('<?php echo $this->fcSystem['banner_banner1'] ?>');">
				<h2 class="heading detalhead uk-container"><span>Tag</span></h2>
			</header>
...
<div class="uk-container uk-container-center">
	...
	<div class="main-banner ec-cover">
		<a href="" title="">
			<img src="templates/frontend/resources/img/upload/banner-3.png" alt="" />
		</a>
	</div>
