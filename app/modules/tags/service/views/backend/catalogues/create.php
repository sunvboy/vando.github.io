					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab-seo">
							<div class="box-body">
								...
								<div class="form-group">
									<label class="col-sm-12 control-label tp-text-left">Chi tiết bài viết hiển thị menu</label>
								</div>
								<div class="form-group">
									<div class="col-sm-12">
								...
								<div class="form-group">
									<label class="col-sm-12 control-label tp-text-left">Giao diện</label>
								</div>
								<div class="form-group">
									<div class="col-sm-12">
