<section class="content-header">
	<h1>Thêm nhóm khách hàng mới</h1>
	<ol class="breadcrumb">
		<li><a href="<?php echo site_url('admin');?>"><i class="fa fa-dashboard"></i> Bảng điều khiển</a></li>
		<li><a href="<?php echo site_url('customers/backend/groups/view');?>">Nhóm khách hàng</a></li>
		<li class="active"><a href="<?php echo site_url('customers/backend/groups/create');?>">Thêm nhóm khách hàng mới</a></li>
	</ol>
</section>
						...
						<div class="tab-pane active" id="tab-info">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<?php echo form_input('title', set_value('title'), 'class="form-control" placeholder="Nhóm khách hàng"');?>
									</div>
								</div>
							</div><!-- /.box-body -->
						</div><!-- /.tab-pane -->
