						...
						<div class="tab-pane active" id="tab-info">
							<div class="box-body">
								...
								<div class="form-group hide">
									...
									<div class="col-sm-4">
										<?php echo form_input('nickname', set_value('nickname'), 'class="form-control" placeholder="Nickname"');?>
									</div>
								</div>
								<div class="form-group">
						...
						<div class="tab-pane" id="tab-advanced">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-sm-2">
										<?php echo form_dropdown('level', $this->BackendLevel_Model->Dropdown(), set_value('level', 0), 'class="form-control" style="width: 100%;"');?>
									</div>
								</div>
							</div><!-- /.box-body -->
						</div><!-- /.tab-pane -->
