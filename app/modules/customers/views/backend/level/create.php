<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active"><a href="<?php echo site_url('customers/backend/level/create');?>">Thêm cấp độ mới</a></li>
	</ol>
</section>
						...
						<div class="tab-pane active" id="tab-info">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-sm-4">
										<?php echo form_input('title', set_value('title'), 'class="form-control" placeholder="Tên cấp độ"');?>
									</div>
									<label class="col-sm-1 control-label">Giảm giá %</label>
									<div class="col-sm-5">
										<?php echo form_input('discounted', set_value('discounted'), 'class="form-control" placeholder="Giảm giá % áp dụng cho mức này"');?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label">Giới hạn tiền</label>
									<div class="col-sm-4">
										<?php echo form_input('range_price', set_value('range_price'), 'class="form-control price" placeholder="Giới hạn tiền thăng cấp"');?>
									</div>
