<div class="wp-dangnhap">
    <div class="wrap-login100 p-l-110 p-r-110 p-t-20 p-b-13">
        <form method="" class="login100-form validate-form flex-sb flex-w" id="RegForm">
            ...
            <div class="reg-error alert"></div>
            <div class="wrap-input100 validate-input register-input" data-validate="">
                <input placeholder="Họ và tên" class="input100" type="text" name="" value="" id="reg_fullname">
                <span class="focus-input100"></span>
            </div>
            <div class="wrap-input100 validate-input register-input" data-validate="">
                <input placeholder="Email" class="input100" type="email" name="email" value="" id="reg_email">
                <span class="focus-input100"></span>
            </div>
            <div class="wrap-input100 validate-input register-input" data-validate="">
                <input placeholder="Số điện thoại: 09.., 01.." class="input100" type="tel" name="mobile" value="" id="reg_phone">
                <span class="focus-input100"></span>
            </div>
            <div class="wrap-input100 validate-input register-input" data-validate="">
                <input placeholder="Mật khẩu, lớn hơn 6 ký tự" class="input100" type="password" name="pass" id="reg_password">
                <span class="focus-input100"></span>
            </div>
            <div class="container-login100-form-btn mt20">
                <button type="submit" class="login100-form-btn" id="submit_reg">
                    Đăng ký
                </button>
            </div>
            <div class="mt-clearfix"></div>
            <div class="mtb10 col-md-12">
                <center>
                    <span class="txt1">
                    Hoặc
                </span>
            ...
            <div class="w-full text-center mt15">
                ...
                <a href="<?php echo site_url('login') ?>" class="txt2 bo1">
                    Đăng nhập
                </a>
            </div>
        </form>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#RegForm').on('submit',function(){
            ...
            $('#submit_reg').html('Sending ....');
            var formURL = 'customers/ajax/auth/register';
            $.post(formURL, {
                email: email,password: password, fullname:fullname, phone: phone},
                function(data){
                    var json = JSON.parse(data);
                    $('#submit_reg').html('Đăng ký');
                    $('.reg-error').show();
                    if(json.flag == false){
                        $('.reg-error').removeClass('alert alert-success').addClass('alert alert-danger');
                        $('.reg-error').html(json.message);
                    }else{
                        $('.reg-error').removeClass('alert alert-danger').addClass('alert alert-success');
                        $('.reg-error').html(json.message);
